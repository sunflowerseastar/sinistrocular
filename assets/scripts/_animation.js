(function(Animation) {
  Animation.animateInTwo = function($this) {
    ...
    var loadingSequence = [
      ...
      },
      {
        e: $animation2,
        p: 'fadeIn',
        o: { duration: 1400, delay: 650, sequenceQueue: false },
      },
    ];
  ...
  Animation.animateInThree = function($this) {
    ...
    var loadingSequence = [
      ...
      },
      {
        e: $animation2,
        p: 'fadeIn',
        o: { duration: 900, delay: 350, sequenceQueue: false },
      },
      {
        e: $animation3,
        p: 'fadeIn',
        o: { duration: 2000, delay: 400, sequenceQueue: false },
      },
    ];
  ...
  Animation.init = function() {
    ...
    $('.animation-fade-in').waypoint(
      function(direction) {
        var $el = $(this.element);

        if (!$el.hasClass('animation-complete')) {
          $el
            .velocity({ opacity: 1 }, 2500, 'easeOutQuart')
